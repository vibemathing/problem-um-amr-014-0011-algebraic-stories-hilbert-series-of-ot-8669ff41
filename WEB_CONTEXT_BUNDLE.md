...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-014-0011-algebraic-stories-hilbert-series-of-ot-8669ff41",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-014-0011-b22654b3b25d",
        "url": "https://www.unsolvedmath.com/problems/AMR-014-0011"
      }
    ],
    "statement": {
      "language": "en",
      "text": "[] For generic forms $g_1,\\ldots,g_r$ of degree $d>1$, the ideal $(g_1^k,\\ldots,g_r^k)$ has the same Hilbert series as the one generated by $r$ generic forms of degree $dk$.",
      "version": 1
    },
    "title": "Algebraic Stories — Hilbert series of other classes of ideals",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "c2c5b5208aaa16a9fbd6db690a28d19a449357403ef7fd14a4f5f8508a8ff0a5"
}
```
